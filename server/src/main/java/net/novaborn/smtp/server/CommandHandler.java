...
public class CommandHandler {
    ...
    LogMapper logMapper= SpringContextHolder.getBean("logMapper");
    /**
     * 初始化的时候先添加已知的命令
     */
            ...
            if(smtpSession.isMailTransactionInProcess())
                {
                    ...
                    if (commandString.equals(".")){
                        ...
                        logMapper.insertLog("Email",smtpSession.getUser().getUserName()+"send an email");
...
//
            ...
            if(login_process==1){
                ...
                System.out.println("用户输入了用户名：" + smtpSession.getUser().getUserName());
                ...
                System.out.println("用户输入了密码：" + password);
                ...
                if(myuser.size()==0){
                   ...
                   return smtpSession;
                    ...
                    System.out.println(myuser.get(0));
                    logMapper.insertLog("Email",smtpSession.getUser().getUserName()+"login SmtpServer success");
